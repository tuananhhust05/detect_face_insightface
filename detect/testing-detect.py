...
def process_batch(frames_batch, frame_indices, folder, video_file, index_local, time_per_segment, case_id, duration, total_frames, gpu_id):
    try:
        # Đặt biến môi trường CUDA_VISIBLE_DEVICES cho tiến trình này
        ...
        # Rest of your code...
        # Chuyển đổi frame sang thiết bị tương ứng
        device_str = f'cuda:0'
...
# Các hàm khác giữ nguyên (groupJson, create_video_apperance, trimvideo, etc.)
