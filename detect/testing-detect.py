...
def process_frames(frames_batch, app, model, device, fps, frame_indices, time_per_segment, index_local, case_id, folder):
    results = []
        ...
        while True:
            ...
            if frame_count % frame_interval == 0:
                ...
                if len(frames_batch) >= 16:
                    process_frames(frames_batch, app, None, device, fps, frame_indices, time_per_segment, index_local, case_id, folder)
                    frames_batch = []
                    frame_indices = []
